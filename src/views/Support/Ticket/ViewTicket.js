...
const Colors = () => {
  ...
  return (
    <>
    <div><h1 style={{color:'#2A87C5'  , marginRight:20}}>View Ticket</h1> </div>
      <hr></hr>
    <CModal 
        show={success} 
      ...
      >
        ...
        <br></br>
             ...
             <CRow>
               ...
               <h6>Attachments</h6>
                ...
                <CRow>
                  ...
                  <CCol md="4">
                    <CButton color="secondary" onClick={() => setSuccess(!success)}>+Add more</CButton>
                  </CCol>
                </CRow>
           </CCol>
         ...
         <CRow>
           ...
           <CButton color="success" onClick={handleClick}>Submit</CButton>{' '}
        ...
        <table className="table table-hover table-outline mb-0 d-none d-sm-table">
              <tr>
                <td className="text-center">
                  <div style={{display:'flex'}}>
                    <div>
                      ...
                      <div className="text-muted" style={{ color:'blue', fontSize:10}}>
                        All replyes
                      </div>
                    </div>
                    
                    <div>
                      <div style={{ fontStyle:'italic', color:'black'}}>Hamza Hussain</div>
                      <div className="text-muted" style={{ color:'blue', textAlign:'left'}}>
                        Client
                      </div>
                    </div>
                  </div>
                ...
                <td className="text-center" style={{fontSize:10}}>
                ...
                <td className="text-center" >
                  <div style={{display:'flex'}}>
                    <div>
                      <div className="c-avatar">
                        <CIcon name="cil-user"></CIcon>
                        <span className="c-avatar-status bg-primary"></span>
          ...
          <table className="table table-hover table-outline mb-0 d-none d-sm-table">
            <thead className="thead-light">
              <tr >
                ...
                <th style={{textAlign:'left',background:'#D9EDF7'}}><CIcon name="cil-people" />Reply</th>
                ...
                <th style={{textAlign:'center',background:'#D9EDF7'}}></th>
                <th style={{textAlign:'center',background:'#D9EDF7'}}></th>
                <th style={{textAlign:'right',background:'#D9EDF7', fontWeight:900, cursor:'pointer'}}><div  onClick={() => setSuccess(!success)} >+</div></th>
            ...
            <tbody id="list">
              <tr>
                <td className="text-center" style={{paddingLeft:50}}>
                  <div style={{display:'flex'}}>
                    <div>
                      <div className="c-avatar">
                        <CIcon name="cil-user" style={{ width:100, height:50}}></CIcon>
                        <span className="c-avatar-status bg-success"></span>
                    ...
                    <div>
                      <div style={{ fontStyle:'italic', color:'black', fontSize:20}}>Hamza Hussain</div>
                      <div className="text-muted" style={{ color:'blue', textAlign:'left'}}>
                        Client
                      </div>
                    </div>
              ...
              <tr>
                <td className="text-center" style={{paddingLeft:40}}>
                  <div style={{display:'flex'}}>
                    <div>
                      <div className="c-avatar">
                        <CIcon name="cil-user" style={{ width:100, height:50}}></CIcon>
